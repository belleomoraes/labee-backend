    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, productsRepository.insertNewProduct(newProduct)];
                case 2:
                    _a.sent();
                    res.sendStatus(200);
                    return [3 /*break*/, 4];
...
function getAllProducts(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var allProducts, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, productsRepository.getProductsData()];
                case 1:
                    allProducts = _a.sent();
...
function removeProductStock(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var name, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
